...
{
  uint allocatedBlocks[100000];    // de array ba7ot feha kol block ally 3mltha alloc
  ...
  for(int i=0;i<8;i++){
      ...
      if(i>0){    // 3shan a3rf a3ml compare m3 mkan ally 2blo
          ...
          {
              i=0;    //start allocating blocks again // low mnf3sh wa7da h3eeed mn elawl
          }
      }
    }
 ...
 */
void
bfree_page(int dev, uint b)   // hna low 3awz a3ml swap in w asheel page 3shan mosh m7tagha, mkan awl block
{ //*******************xv7*****************
