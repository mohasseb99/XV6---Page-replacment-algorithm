...
main(int argc, char *argv[])
{
  ...
  15:	68 ad 08 00 00       	push   $0x8ad
  1a:	6a 01                	push   $0x1
  1c:	e8 df 04 00 00       	call   500 <printf>
	mem();
...
00000030 <mem>:
{
  ...
  38:	56                   	push   %esi
  39:	53                   	push   %ebx
  3a:	83 ec 24             	sub    $0x24,%esp
	printf(1, "mem test\n");
  3d:	68 68 08 00 00       	push   $0x868
  42:	6a 01                	push   $0x1
  44:	e8 b7 04 00 00       	call   500 <printf>
	m1 = malloc(4096);
  49:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  50:	e8 0b 07 00 00       	call   760 <malloc>
	if (m1 == 0)
  55:	83 c4 10             	add    $0x10,%esp
	m1 = malloc(4096);
  58:	89 45 e0             	mov    %eax,-0x20(%ebp)
	if (m1 == 0)
  5b:	85 c0                	test   %eax,%eax
  5d:	74 4a                	je     a9 <mem+0x79>
  5f:	89 c3                	mov    %eax,%ebx
	uint count = 0;
  61:	31 ff                	xor    %edi,%edi
  63:	eb 2b                	jmp    90 <mem+0x60>
  65:	8d 76 00             	lea    0x0(%esi),%esi
		*(char**)m1 = m2;
  68:	8b 55 e4             	mov    -0x1c(%ebp),%edx
		printf(1, "CurrCount: %d\n", ((int*)m1)[2]);
  6b:	83 ec 04             	sub    $0x4,%esp
		((int*)m1)[2] = count++;
  6e:	8d 77 01             	lea    0x1(%edi),%esi
		*(char**)m1 = m2;
  71:	89 02                	mov    %eax,(%edx)
		((int*)m1)[2] = count++;
  73:	89 7a 08             	mov    %edi,0x8(%edx)
		printf(1, "CurrCount: %d\n", ((int*)m1)[2]);
  76:	57                   	push   %edi
  77:	68 72 08 00 00       	push   $0x872
  7c:	6a 01                	push   $0x1
  7e:	e8 7d 04 00 00       	call   500 <printf>
	while (cur < TOTAL_MEMORY) {
  83:	83 c4 10             	add    $0x10,%esp
  86:	81 fe 60 02 00 00    	cmp    $0x260,%esi
  8c:	74 2f                	je     bd <mem+0x8d>
  8e:	89 f7                	mov    %esi,%edi
		m2 = malloc(4096);
  90:	83 ec 0c             	sub    $0xc,%esp
  93:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  96:	68 00 10 00 00       	push   $0x1000
  9b:	e8 c0 06 00 00       	call   760 <malloc>
		if (m2 == 0)
  ...
  a7:	75 bf                	jne    68 <mem+0x38>
	printf(1, "test failed!\n");
  a9:	83 ec 08             	sub    $0x8,%esp
  ac:	68 9f 08 00 00       	push   $0x89f
  b1:	6a 01                	push   $0x1
  b3:	e8 48 04 00 00       	call   500 <printf>
	exit();
  b8:	e8 d6 02 00 00       	call   393 <exit>
	((int*)m1)[2] = count;
  bd:	c7 43 08 60 02 00 00 	movl   $0x260,0x8(%ebx)
	printf(1, "\n\nWhile Loop Over\n");
  c4:	53                   	push   %ebx
  c5:	53                   	push   %ebx
  c6:	68 81 08 00 00       	push   $0x881
  cb:	6a 01                	push   $0x1
  cd:	e8 2e 04 00 00       	call   500 <printf>
  d2:	83 c4 10             	add    $0x10,%esp
	count = 0;
  d5:	31 c0                	xor    %eax,%eax
  d7:	eb 19                	jmp    f2 <mem+0xc2>
  d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		m1 = *(char**)m1;
  e0:	8b 4d e0             	mov    -0x20(%ebp),%ecx
		count++;
  e3:	83 c0 01             	add    $0x1,%eax
		m1 = *(char**)m1;
  e6:	8b 09                	mov    (%ecx),%ecx
  e8:	89 4d e0             	mov    %ecx,-0x20(%ebp)
	while (count != total_count) {
  eb:	3d 60 02 00 00       	cmp    $0x260,%eax
  f0:	74 1b                	je     10d <mem+0xdd>
		if (((int*)m1)[2] != count)
  f2:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  f5:	3b 41 08             	cmp    0x8(%ecx),%eax
  f8:	74 e6                	je     e0 <mem+0xb0>
			printf(1, "CurrCount: %d\n", count);
  fa:	51                   	push   %ecx
  fb:	50                   	push   %eax
  fc:	68 72 08 00 00       	push   $0x872
 101:	6a 01                	push   $0x1
 103:	e8 f8 03 00 00       	call   500 <printf>
			goto failed;
 108:	83 c4 10             	add    $0x10,%esp
 10b:	eb 9c                	jmp    a9 <mem+0x79>
	printf(1, "mem ok %d\n", bstat());
 10d:	e8 21 03 00 00       	call   433 <bstat>
 112:	52                   	push   %edx
 113:	50                   	push   %eax
 114:	68 94 08 00 00       	push   $0x894
 119:	6a 01                	push   $0x1
 11b:	e8 e0 03 00 00       	call   500 <printf>
	exit();
 120:	e8 6e 02 00 00       	call   393 <exit>
...
printf(int fd, char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb d5 08 00 00       	mov    $0x8d5,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d5:	a1 c0 0b 00 00       	mov    0xbc0,%eax
{
...
malloc(uint nbytes)
{
 ...
 76d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 770:	8b 3d c0 0b 00 00    	mov    0xbc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e2:	e8 e9 fe ff ff       	call   6d0 <free>
  return freep;
 7e7:	a1 c0 0b 00 00       	mov    0xbc0,%eax
 ...
 814:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 817:	a3 c0 0b 00 00       	mov    %eax,0xbc0
}
