...
main(int argc, char *argv[])
{
  ...
  15:	e8 19 03 00 00       	call   333 <bstat>
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	eb 1a                	jmp    5a0 <printf+0x1a0>
          s = "(null)";
 586:	bb 7f 07 00 00       	mov    $0x77f,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d5:	a1 30 0a 00 00       	mov    0xa30,%eax
{
 ...
 5f6:	73 10                	jae    608 <free+0x38>
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 629:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 66d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 670:	8b 3d 30 0a 00 00    	mov    0xa30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	8b 3d 30 0a 00 00    	mov    0xa30,%edi
 ...
 6e2:	e8 e9 fe ff ff       	call   5d0 <free>
  return freep;
 6e7:	a1 30 0a 00 00       	mov    0xa30,%eax
 ...
 714:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 717:	a3 30 0a 00 00       	mov    %eax,0xa30
}
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 34 0a 00 00       	mov    $0xa34,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 34 0a 00 00 34 	movl   $0xa34,0xa34
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 74b:	c7 05 38 0a 00 00 00 	movl   $0x0,0xa38
 752:	00 00 00 
    if(p->s.size >= nunits){
